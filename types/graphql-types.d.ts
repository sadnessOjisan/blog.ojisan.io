...
export type ImagesQuery = {
  allFile: {
    edges: Array<{
      node: Pick<File, "relativePath" | "name"> & {
...
export type BlogTemplateQuery = {
  post?: Maybe<
    Pick<
      MarkdownRemark,
      "excerpt" | "html" | "rawMarkdownBody" | "tableOfContents"
    > & {
      frontmatter?: Maybe<
        Pick<
          MarkdownRemarkFrontmatter,
          "created" | "updated" | "path" | "title" | "tags" | "isProtect"
        > & {
          visual?: Maybe<{
            childImageSharp?: Maybe<{
              fluid?: Maybe<GatsbyImageSharpFluidFragment>
...
export type AllPostsByUserIdQuery = {
  postsByUserId: {
    nodes: Array<
