...
「[Firebase](https://firebase.google.com/?hl=ja) は安いし楽だしマジ最高」という一心で技術選定してしまったプロダクトが成功してしまったが故の苦しみ、割高なコスト・権限管理・カスタマイズ性、そして （特性やスキルセット的に）RDB 製品が適していたのに無理やり Firestore を採用したことによるデータ不整合。
...
またコード例は React ですが、hooks 以外は他の FW でも当てはまるお話ですので適宜読み飛ばすと参考になると思います。
...
さらに easy なインターフェースを持つことから開発速度を出しやすく、 **Firebase は予算的なリソースや人的なリソースが潤沢でないチームにとっては魅力的なもの**です。
