...
![tweet. WebRTCをReactやらNextの上で動かしてビデオ通話を実装するの、勘所が分かってきた。というか両方に詳しくないとまともなビデオ通話UI作れないと思った。ブログのネタにしたいがなんか希少スキルぽさを感じてしまい珍しく外に出したくない気持ちになってる。これで一稼ぎさせてくれ…広い家…車…庭…](./pos.png)
