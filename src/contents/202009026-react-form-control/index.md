...
React.memo などを駆使すればある程度緩和ができるものだとは思いますが、これらはコンポーネントが更新されないといった事故の元にもなるので、既存コードへの memo の導入は慎重にならなければいけません。
...
たくさん項目があるフォームの場合それぞれに ref を持たせるのはめんどくさかったりします。
...
そうすることでパフォーマンスにまつわるトラブルを回避できると思います。
